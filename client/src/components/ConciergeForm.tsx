    ...
    >
      <Card className="w-full max-w-sm md:max-w-2xl -ml-2 md:mx-auto shadow-xl border-t-4 border-t-accent bg-white/95 backdrop-blur-sm scale-95 md:scale-100 origin-top">
        <CardHeader className="hidden md:flex p-2 md:p-6 pt-1 md:pt-6">
          <CardTitle className="text-lg md:text-2xl">Book an Inspector</CardTitle>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-1.5 md:space-y-4 form-spacing">
              <div className="grid grid-cols-2 gap-1.5 md:gap-4 grid-spacing">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Full Name</FormLabel>
                      <FormControl>
                        <Input 
                          placeholder="" 
                          {...field} 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Agency / Brokerage</FormLabel>
                      <FormControl>
                        <Input 
                          placeholder="" 
                          {...field} 
              ...
              <div className="grid grid-cols-2 gap-1.5 md:gap-4 grid-spacing">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Phone Number</FormLabel>
                      <FormControl>
                        <Input 
                          placeholder="" 
                          {...field} 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Sq. Ft.</FormLabel>
                      <FormControl>
                        <Input 
                          placeholder="" 
                          {...field} 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[14px] md:text-[14px]">Inspection Address</FormLabel>
                    <FormControl>
                      <Input 
                        placeholder="" 
                        {...field} 
              ...
              <div className="grid grid-cols-2 gap-1.5 md:gap-4 grid-spacing">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Inspection Date</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[14px] md:text-[14px]">Time of Inspection</FormLabel>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[14px] md:text-[14px]">Add-ons</FormLabel>
                    <FormControl>
                      <Textarea 
                        placeholder="Radon testing, mold inspection, etc." 
                        className="resize-none bg-white text-[13px] md:text-sm placeholder:text-[13px] md:placeholder:text-sm h-9 md:h-28 overflow-hidden md:overflow-auto" 
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[14px] md:text-[14px]">How did you hear about us?</FormLabel>
                    <FormControl>
                      <Input 
                        {...field} 
                        className="bg-white"
              ...
              <Button 
                type="submit" 
                className="w-[356px] md:w-full mx-auto bg-accent hover:bg-accent/90 text-white font-semibold text-[14px] md:text-lg h-10 md:h-12 shadow-md transition-all hover:scale-[1.02] px-4"
