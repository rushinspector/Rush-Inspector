        ...
        <CardContent className="p-2 pt-0.5 pb-0 md:p-6 md:pt-0">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 md:space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-auto md:w-full mx-auto bg-accent hover:bg-accent/90 text-white font-semibold text-[12px] md:text-lg h-10 md:h-12 shadow-md transition-all hover:scale-[1.02] px-16 md:px-4"
