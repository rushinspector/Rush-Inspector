...
export default function ConciergeForm() {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-2xl mx-auto shadow-xl border-t-4 border-t-accent bg-white/95 backdrop-blur-sm px-3 md:px-0">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea 
                        ...
                        className="resize-none bg-white text-[13px] md:text-sm placeholder:text-[13px] md:placeholder:text-sm" 
                        {...field}
