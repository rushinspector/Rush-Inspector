    ...
    >
      <Card className="w-full max-w-sm md:max-w-2xl mx-auto shadow-xl border-t-4 border-t-accent bg-white/95 backdrop-blur-sm scale-[1.05] md:scale-100 origin-top">
        <CardHeader className="hidden md:flex p-2 md:p-6 pt-1 md:pt-6">
          <CardTitle className="text-lg md:text-2xl">Find a rush inspector</CardTitle>
        ...
        <CardContent className="p-2 pt-0.5 pb-0 md:p-6 md:pt-0 mobile-compact-form">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-1.5 md:space-y-4 form-spacing">
              ...
              <Button 
                type="submit" 
                className="w-[340px] md:w-full mx-auto bg-accent hover:bg-accent/90 text-white font-semibold text-[14px] md:text-lg h-9 md:h-12 shadow-md transition-all hover:scale-[1.02] px-4"
