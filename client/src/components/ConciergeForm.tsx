...
export default function ConciergeForm() {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-sm md:max-w-2xl mx-auto shadow-xl border-t-4 border-t-accent bg-white/95 backdrop-blur-sm scale-95 md:scale-100 origin-top">
