        ...
        <CardContent className="p-2 pt-0.5 pb-0 md:p-6 md:pt-0 mobile-compact-form">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-1.5 md:space-y-4 form-spacing">
              ...
              <Button 
                type="submit" 
                className="w-auto md:w-full mx-auto bg-accent hover:bg-accent/90 text-white font-semibold text-[14px] md:text-lg h-9 md:h-12 shadow-md transition-all hover:scale-[1.02] px-32 md:px-4"
              ...
              >
                {mutation.isPending ? "Submitting..." : (
                  <>
                    ...
                    <span className="md:hidden" style={{ fontSize: '17px' }}>Book Inspection</span>
                  </>
                )}
              </Button>
