                        ...
                        <PopoverContent className="w-auto p-3 bg-white" align="start">
                          <Calendar
                            ...
                            classNames={{
                              ...
                              week: "flex mt-1",
                              day: "w-8 h-8 p-0 text-center relative flex items-center justify-center",
                              day_button: "w-8 h-8 p-0 text-sm font-normal rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1 inline-flex items-center justify-center",
