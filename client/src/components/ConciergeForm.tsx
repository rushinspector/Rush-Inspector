...
export default function ConciergeForm() {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-[410px] md:max-w-2xl -ml-2 md:mx-auto shadow-xl border-t-4 border-t-accent bg-white/95 backdrop-blur-sm scale-[0.97] md:scale-100 origin-top">
