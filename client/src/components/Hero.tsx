    ...
    <section className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="hero-title font-display font-bold leading-[1.1]">
              Can't find an <br/>
              <span className="text-accent">inspector?</span>
            </h1>
            
            <p className="text-[18.5px] md:text-2xl lg:text-3xl text-gray-100 max-w-xl mt-10 lg:mt-18">
            ...
            <div className="space-y-2 pt-2">
              ...
              <p className="text-white font-light mt-6 text-[15px] md:text-[20px]">$349 coordination fee (inspector paid directly)</p>
            </div>
          ...
          <div className="lg:pl-12 -mt-8 lg:mt-0">
            <div className="disclaimer-text text-xl lg:text-sm text-gray-400 max-w-2xl ml-2 lg:ml-5 mr-0 mb-1"> We match licensed & insured professionals; verify independently.</div>
            <ConciergeForm />
          </div>
        </div>
      </div>
