    ...
    <section className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-[65px] md:text-[70px] font-display font-bold leading-[1.1]">
              Can't find an <br/>
            ...
            <div className="flex flex-wrap items-center justify-start gap-x-6 md:gap-x-8 gap-y-2 pt-6 lg:pt-8 text-sm text-gray-300">
