      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="md:text-xl font-bold text-[#f8f8fa] -mt-4 text-[20px]">$349 coordination fee — inspector paid directly</div>
            <p className="md:text-xl text-gray-200 max-w-lg mt-[11px] mb-[11px] text-[17px]">Rush Inspector quickly finds and books a fully licensed home inspector for your job. If we can’t secure one within 24 hours, you pay nothing.</p>
