      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="md:text-xl text-gray-200 max-w-lg mt-[11px] mb-[11px] text-[18px]">We'll find you a fully licensed inspector in 24 hours. If we can’t secure one, you pay nothing.</p>
