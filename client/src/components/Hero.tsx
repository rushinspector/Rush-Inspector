    ...
    <section className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="hero-title font-display font-bold leading-[1.25] md:leading-[1.1] lg:leading-[1.35]">
              Can't find an <br/>
              <span className="text-accent">inspector?</span>
            </h1>
            
            <p className="text-[17.2px] md:text-2xl lg:text-[33.5px] text-gray-100 max-w-xl mt-6 md:mt-10 lg:mt-18 font-bold md:font-medium leading-tight">
