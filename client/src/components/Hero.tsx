...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center py-10 md:py-20 overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[20px] md:text-2xl lg:text-3xl text-gray-100 max-w-xl mt-6 md:mt-10 lg:mt-18">
            ...
            <div className="space-y-2 pt-2">
              ...
              <p className="text-white font-light -mt-2 md:mt-6 text-[13.5px] md:text-[20px]">$349 coordination fee (inspector paid directly)</p>
            </div>
