        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-2 pt-2">
              ...
              <p className="text-white -mt-2 md:mt-6 lg:mt-3 text-[14.5px] md:text-[20px]"><span className="font-semibold md:font-light">$349 coordination fee</span><span className="font-light"> (inspector paid directly)</span></p>
            </div>
