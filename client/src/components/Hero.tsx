    ...
    <section className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block px-4 py-1 bg-accent/20 border border-accent/50 rounded-full text-accent font-medium mb-2 backdrop-blur-sm text-[15px]">Licensed Inspector Usually Booked Within 24 Hours</div>
          ...
          <div className="lg:pl-12">
            <div className="text-xs text-gray-400 max-w-md mx-auto mt-[2px] mb-[2px] ml-[57px] mr-[57px]"> We match licensed & insured professionals; verify independently.</div>
            <ConciergeForm />
          </div>
        </div>
      </div>
