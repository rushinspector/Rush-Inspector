      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[16px] md:text-2xl lg:text-[32.5px] hero-subtitle text-gray-100 max-w-xs md:max-w-xl mt-6 md:mt-10 lg:mt-12 font-bold md:font-medium leading-tight">
            ...
            <div className="space-y-2 pt-2">
              <p className="text-gray-200 font-semibold text-[16px] md:text-xl lg:text-[24px] -mt-3 md:mt-0 lg:mt-6">
                Serving Hamilton County & Greater Cincinnati
              </p>
              <p className="text-white -mt-2 md:mt-8 lg:mt-3 text-[14.5px] md:text-[20px]"><span className="font-semibold md:font-light lg:font-semibold">$349 coordination fee</span><span className="font-light"> (inspector paid directly)</span></p>
            </div>
