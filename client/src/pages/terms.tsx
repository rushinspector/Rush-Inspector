    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          <h1 className="font-display text-[29px] md:text-4xl font-bold text-primary mb-2" data-testid="text-terms-title">
            Rush Inspector – Terms of Service
          </h1>
          <p className="text-[15px] md:text-base text-gray-500 mb-8">Last updated: December 1, 2025</p>

          <div className="space-y-8 text-[15px] md:text-base text-gray-700 leading-relaxed">
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">1. Nature of Service</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">2. 24-Hour Inspector Match Guarantee</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">3. Matching Fee and Refund Policy</h2>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">4. Payment to Inspector</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">5. No Employment or Agency Relationship</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">6. User / Client Responsibilities</h2>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">7. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">8. Governing Law</h2>
            ...
            <section>
              <h2 className="font-semibold text-[17px] md:text-lg text-primary mb-2">9. Modification of Terms</h2>
              <p>
